...
export default function FeaturesGuideModal({ 
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-900/70 backdrop-blur-xs flex items-center justify-center p-2 sm:p-4 lg:p-6 overflow-hidden animate-in fade-in duration-150">
      <div className="bg-white rounded-2xl sm:rounded-3xl w-full max-w-[98vw] 2xl:max-w-[1600px] shadow-2xl overflow-hidden flex flex-col h-[94dvh] max-h-[96dvh] border border-slate-200/80">
        
        {/* TOP HEADER: Spotlight Search Bar & Controls */}
        <div className="bg-slate-900 text-white px-4 sm:px-6 py-3.5 sm:py-4 flex items-center justify-between border-b border-slate-800 gap-3 shrink-0">
          
          {/* Brand & Badge */}
          <div className="flex items-center space-x-3 shrink-0">
            <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-2xl bg-gradient-to-tr from-red-600 to-rose-500 flex items-center justify-center text-white shadow-md">
            ...
            <div>
              <div className="flex items-center space-x-2">
                ...
                <span className="hidden sm:inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-red-500/20 border border-red-500/40 text-red-400 text-[10px] font-bold uppercase tracking-wider">
          ...
          <div className="flex-1 max-w-xl mx-2 sm:mx-4">
            <div className="relative">
              ...
              <input
                ...
                placeholder="Tìm kiếm tính năng, phím tắt (vd: chấm máy, task 1, band 6.0, Alt+F)..."
                className="w-full pl-10 pr-9 py-2 rounded-xl bg-slate-800/90 border border-slate-700 text-xs sm:text-sm text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-red-500/50 focus:border-red-500 transition-all"
              />
              {searchQuery && (
                <button 
          ...
          {/* Right Action: Shortcut Hint & Close */}
        ...
        <div className="flex-1 flex overflow-hidden min-h-0 bg-slate-100">
          ...
          <div className={`w-full lg:w-80 xl:w-96 bg-white border-r border-slate-200 flex flex-col shrink-0 ${mobileTab === 'list' ? 'block' : 'hidden lg:flex'}`}>
