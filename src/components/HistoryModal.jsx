          ...
          {activeTab === 'speaking' && (
            speakingHistory.length > 0 ? (
                    ...
                    <div className="space-y-1.5 flex-1 min-w-0">
                      <div className="flex items-center space-x-2">
                        ...
                        {rec.durationSec && (
                          <span className="text-[11px] text-slate-400 flex items-center space-x-1">
                            <Clock className="w-3 h-3" />
                            <span>{Math.round(rec.durationSec / 60)} phút</span>
                          </span>
                        )}
                        {rec.examiner?.name && (
                          <span className="text-[10px] font-bold text-slate-500 bg-slate-100 px-1.5 py-0.5 rounded">
                            GK: {rec.examiner.name}
                          </span>
                        )}
                      </div>
                    ...
                    <div className="flex items-center space-x-2 shrink-0 self-end sm:self-center">
                      {onViewSpeakingSubmission && (
                        <button
                          ...
                          className="px-3 py-1.5 rounded-lg bg-purple-50 hover:bg-purple-100 text-purple-700 font-bold text-xs flex items-center space-x-1 transition-colors cursor-pointer"
              ...
              <div className="text-center py-16 text-slate-400 text-xs space-y-2">
                ...
                <p>Bạn chưa có bài thi Speaking nào. Hãy tham gia thi thử với Giám khảo AI để lưu lại lịch sử!</p>
              </div>
            )
          )}
