          ...
          >
            ...
            <div className="flex items-center justify-between pb-3 border-b border-slate-100">
              <button
                ...
                className="flex items-center space-x-2.5 p-2 rounded-xl bg-slate-50 border border-slate-200 text-left w-full mr-2"
              >
                ...
                <div className="truncate">
                  ...
                  <div className="text-[10px] text-slate-400">
                    {user ? 'Đồng bộ dữ liệu đám mây' : 'Lưu bài & từ vựng trên mọi thiết bị'}
                  </div>
                </div>
              </button>
              <button 
